...
echo ""
echo -e "${YELLOW}3x-ui Reality Inbound Setup:${NC}"
echo -e "  Create a VLESS inbound in the 3x-ui panel with these Reality settings:"
echo -e "  ${CYAN}Protocol:${NC}     vless"
echo -e "  ${CYAN}Port:${NC}         443"
echo -e "  ${CYAN}Security:${NC}     Reality"
echo -e "  ${CYAN}uTLS:${NC}         chrome"
echo -e "  ${CYAN}Target:${NC}       ${YELLOW}127.0.0.1:8444${NC}"
echo -e "  ${CYAN}SNI:${NC}          ${REALITY_COVER_SITE%%:*},${DOMAIN}"
echo -e "  ${CYAN}Cover Site:${NC}   ${REALITY_COVER_SITE:-petrovich.ru:443}"
echo ""
echo -e "  Traffic flow:"
echo -e "    :443 Reality client  → xray proxy"
echo -e "    :443 SNI ${DOMAIN} → Traefik → WG-Easy"
echo -e "    :443 other SNI      → ${REALITY_COVER_SITE%%:*} (camouflage)"
echo -e "    :15672               → Traefik → 3x-ui panel"
echo ""
